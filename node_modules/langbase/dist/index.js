...
var Request = class {
  ...
  buildHeaders({
    ...
    const sanitizedHeaders = headers ? Object.fromEntries(
...
var Workflow = class {
  constructor(config) {
    ...
    this.debug = (_a = config == null ? void 0 : config.debug) != null ? _a : false;
    this.name = (_b = config == null ? void 0 : config.name) != null ? _b : "workflow";
    this.langbase = config == null ? void 0 : config.langbase;
    if (this.langbase) {
