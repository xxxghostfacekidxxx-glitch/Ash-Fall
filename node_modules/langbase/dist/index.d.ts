...
declare class Request {
    ...
    private handleRunResponse;
    post<T>(options: Omit<RequestOptions, 'method'>): Promise<T>;
    get<T>(options: Omit<RequestOptions, 'method' | 'body'>): Promise<T>;
    put<T>(options: Omit<RequestOptions, 'method'>): Promise<T>;
    delete<T>(options: Omit<RequestOptions, 'method' | 'body'>): Promise<T>;
}
